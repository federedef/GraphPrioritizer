...
option_list <- list(
  ...
  make_option(c("-o", "--output_path"), default=".", type="character", default="output",
...
output_matrix <- file.path(opt$output, paste0("filtered_",opt$input_matrix))
# Return the matrix network.
